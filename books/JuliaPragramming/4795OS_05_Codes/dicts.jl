d1 = [1 => 4.2, 2 => 5.3] # 버전 0.3-0.4에서 정상 작동한다
# d1 = Dict(1 => 4.2, 2 => 5.3) # 버전 0.4부터
d1 = {1 => 4.2, 2 => 5.3} # 버전 0.3-0.4에서 정상 작동한다
# d1 = Dict{Any,Any}(1 => 4.2, 2 => 5.3) # 버전 0.4부터
d2 = {"a"=>1, (2,3)=>true} # 버전 0.3-0.4에서 정상 작동한다
# d2 = Dict{Any,Any}("a"=>1, (2,3)=>true) # 버전 0.4부터

d3 = [:A => 100, :B => 200]
# d3 = Dict(:A => 100, :B => 200) # 버전 0.4부터
d3[:B] #> 200
...
d5 = Dict(keys1, values1) # 버전 0.3-0.4에서 정상 작동한다
# d5 = Dict(zip(keys1, values1)) # 버전 0.4부터
#>
d5 = [ "J.S. Bach" => 1685, # 버전 0.3-0.4에서 정상 작동한다
       "Woody Allen" => 1935,
       "Barack Obama" => 1961 ]
# d5 = Dict("J.S. Bach" => 1685,
#       "Woody Allen" => 1935,
#       "Barack Obama" => 1961) # 버전 0.4부터
