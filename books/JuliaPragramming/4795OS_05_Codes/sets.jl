...
s = Set(Any[11, 14, 13, 7, 14, 11]) # 버전 0.4부터
#> Set{Int64}({7,14,13,11})
# 더 나은 방법:
# s1 = Set({11, 25})
s1 = Set(Any[11, 25]) # 버전 0.4부터
# s2 = Set({25, 3.14})
s2 = Set(Any[25, 3.14]) #버전 0.4부터
...
issubset(s1, Set(Any[11, 25, 36])) #> true # 버전 0.4부터
